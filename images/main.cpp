...
int dir=4,dx[5]={1,0,-1,0,0},dy[5]={0,-1,0,1,0},viteza=100,num=1,mat[100][100],moveAI[100],nrMovesAI;
...
void inteligent()
{
    int prim,ultim,i,mat[100][100]={0},coada[2][100]={0},x,y;
